...
### Цель
Научиться **находить**, **законно использовать**, **программно получать** и **собирать** датасет из открытых источников (API/порталы/репозитории), приводить его к **табличному виду** и построить анализ с графиками.
